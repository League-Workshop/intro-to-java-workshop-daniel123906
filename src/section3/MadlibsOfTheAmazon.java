...
JOptionPane.showInputDialog("enter a verb");
		// Get the user to enter a place
JOptionPane.showInputDialog("enter a place");
...
String story = "Pihanas are more "+Adjective+" during the day"
		+ ", so cross the river at night. Piranhas are attracted to fresh "+liquid+" and will most";
			 likely take a bite out of your "+bodypart+" if you"; 
